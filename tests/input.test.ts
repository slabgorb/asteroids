...
// field set (left/right/thrust/fire/hyperspace) so a stray or missing control
// is caught immediately, and guarantees NO_INPUT is genuinely all-false.

import { describe, it, expect } from 'vitest'
import { NO_INPUT, type Input } from '../src/core/input'

const EXPECTED_FIELDS = ['fire', 'hyperspace', 'left', 'right', 'thrust']

describe('Input / NO_INPUT', () => {
  it('exposes exactly the five abstract controls', () => {
